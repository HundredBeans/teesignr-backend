			...
			<table style="padding:10px 15px;font-size:14px" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#F96C00" align="center">
				<tbody><tr>
					<td style="padding:5px 0 0" width="60%" align="center">
						<span style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;color:#fff">WELCOME TO TEESIGNR!</span>
					</td>
				</tr>
			</tbody></table>
		</td>
	...
	<tr>
		<td style="padding:25px 15px 10px">
			<table width="100%">
				...
				<tr>
					<td>
						<p style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;margin:0;font-size:16px;line-height:24px;color:rgba(0,0,0,0.70)">Thanks for signing up!<br>
                            We hope you have a great time selling design and/or exploring t-shirts in Teesignr. If you need any help, please don't hestitate to get in touch at this e-mail or our CEO at daffa@alterra.id<br></p>
					</td>
                </tr>
                <tr>
                    <td>
